<html>
    <body>
        ...
        <form action="calcular_encomenda1.php" method="post">
            Digitar nome da pizza: 
            <select name="nome_pizza">
                <option Napoletana="Napoletana">Napoletana</option>
                <option value="Anchovas">Anchovas</option>
                <option value="Margueritha">Margueritha</option>
            </select>
            <br>
